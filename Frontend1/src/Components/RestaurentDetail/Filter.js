...
//     }
//     useEffect(() =>{
//         fetch(`http://localhost:7070/restaurant/filter/1`, requestOptions)
...
//         console.log("handleCusineChange called",event.target)
...
//                                     </div>
//                                     <div>
//                                         <input type="radio" name="cost" onChange={()=>handleCostChange(0,10000)} />
...
//                                          <img className="img" alt="" src={require('../../Assets/Images/breakfast.jpg')} /> 
//                                      </div> 
...
export default function Filter() {
  ...
  //call API
  useEffect(() => {
      fetch(`http://localhost:7070/restaurant/filter/${currentPage}`,requestOptions)
       .then(response=>response.json())
       .then(data => {
                            ...
                            <div className="col-sm-9 col-md-9 col-lg-9 scroll">
                             {
                                 ...
                                 <div className="row pl-1">
                                     <div className="col-sm-4 col-md-4 col-lg-4">
                                         <img className="img" src={require('../../Assets/Images/breakfast.jpg')} />
                                     </div>
                                     <div className="col-sm-8 col-md-8 col-lg-8">
                                         <div className="rest-name">{item.name}</div>
                                         <div className="res-location">{item.locality}</div>
